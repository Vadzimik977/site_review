...
### 14. 🔴 БАГ: Платёж по СБП не работает
...
5. 🔴 **Высокий:** Исправить кнопку "Оформить аренду" (сделать кликабельной или скрыть)
6. 🟡 **Средний:** Добавить бургер-меню на мобильные устройства
7. 🟡 **Средний:** Убрать ссылку с кнопки "Рассчитать доходность"
8. 🟡 **Средний:** Унифицировать дизайн модалки с основным сайтом
9. 🟡 **Средний:** Улучшить дизайн выбора периода (плашки → кнопки)
10. **Высокий:** Добавить страницу "О нас" (`/about`)
11. **Высокий:** Добавить страницу "Контакты" (`/contacts`)
12. **Средний:** Добавить отзывы клиентов на лендинг
13. **Средний:** Добавить CTA "Связаться с нами" в хедер
14. **Низкий:** Добавить FAQ
15. **Низкий:** Добавить блог с статьями о хранении
