...
### 8.1. 🔴 UX: Кнопка "Расчёт" за видимой частью экрана

Кнопка "Расчёт" находится за видимой частью формы. Пользователи заполняют поля и не видят кнопку отправки — теряются и думают, что форма не работает.

![Кнопка за видимой частью](calc_button_hidden.png)

**Решение:** Сделать кнопку фиксированной внизу модалки или всегда видимой (sticky).
...
| 8.1 | Кнопка "Расчёт" за видимой частью экрана | 🔴 |
