...
![Нет возврата в ЛК с карты](map_no_back_lk.png)
...
### Баг #11: С карты нельзя вернуться в ЛК
![Нет возврата в ЛК с карты](map_no_back_lk.png)
- **Описание:** При переходе из ЛК на карту, нет кнопки "Назад" в личный кабинет
