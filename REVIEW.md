...
| Мобильная навигация | 🟡 UX | Нет бурurger-меню, неудобно возвращаться на главную |
...
4. 🟡 **Средний:** Добавить бургер-меню на мобильные устройства
5. 🟡 **Средний:** Убрать ссылку с кнопки "Рассчитать доходность"
5. **Высокий:** Добавить страницу "О нас" (`/about`)
6. **Высокий:** Добавить страницу "Контакты" (`/contacts`)
7. **Средний:** Добавить отзывы клиентов на лендинг
8. **Средний:** Добавить CTA "Связаться с нами" в хедер
9. **Низкий:** Добавить FAQ
10. **Низкий:** Добавить блог с статьями о хранении
