...
2. **Высокий:** Добавить страницу "О нас" (`/about`)
3. **Высокий:** Добавить страницу "Контакты" (`/contacts`)
4. **Средний:** Добавить отзывы клиентов на лендинг
5. **Средний:** Добавить CTA "Связаться с нами" в хедер
6. **Низкий:** Добавить FAQ
7. **Низкий:** Добавить блог с статьями о хранении
